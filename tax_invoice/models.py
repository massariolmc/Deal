...
class TaxInvoice(models.Model):
    ...
    dt_issue = models.DateField(_('Issue Date'), max_length=100, blank=True)
    ...
    value = models.DecimalField(_('Invoice Value'), decimal_places=2, max_digits=12, blank=False)
    pay_day = models.DateField(_('Payment Day'),max_length=100, blank=True)
    telecom_data = models.CharField(_('Telecom Data'), max_length=100, blank=True)
    time_start = models.DateField(_('Time Start'), max_length=100, blank=True)
    time_end = models.DateField(_('Time End'), max_length=100, blank=True)
    forfeit_satus = models.CharField(_('Forfeit Status'), max_length=100, choices = yes_or_no, blank=True)
    value_forfeit = models.DecimalField(_('Value Forfeit'), decimal_places=2, max_digits=12, blank=True)    
